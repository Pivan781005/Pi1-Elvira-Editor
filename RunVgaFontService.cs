...
internal static class RunVgaFontService
{
    ...
    public static void SaveCopy(FontLoadResult loaded, string destinationPath, string? gameRoot = null)
    {
        ...
        // loaded source executable itself, nor land anywhere else inside the
        // known game installation. Owned VARIANTS output belongs to builds.
