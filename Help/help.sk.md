...
Otvorenie/náhľad nevytvorí zálohu. Samostatný Editor písma **Aplikovať zmeny do EXE** vytvorí nemennú O-zálohu (RUNVGAO.EXE/RUNITO.EXE) pred zápisom. Generovanie launcheru vytvorí nemenný .BAK raz. Bežné projektové Text/Grafika úpravy nezapisujú O-súbory do GameRoot; ukladajú sa do stavu projektu a materializujú sa cez CompositeBuild do vlastných VARIANTS. Obnovovacie operácie sú výslovné a ohraničené na editorom vlastnené meniteľné zálohy.
