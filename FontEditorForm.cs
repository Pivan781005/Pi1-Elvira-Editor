...
internal sealed class FontEditorForm : Form
{
    ...
    private static string LocalizedLayout(RunVgaFontLayout layout) => (UiText.Language, layout) switch
    {
        ...
        (UiLanguage.Slovak, RunVgaFontLayout.OriginalPackedAscii98) => "Elvira II pôvodný / PACKED font (98 znakov)",
        ...
        (UiLanguage.Czech, RunVgaFontLayout.OriginalPackedAscii98) => "Elvira II původní / PACKED font (98 znaků)",
        ...
        (_, RunVgaFontLayout.OriginalPackedAscii98) => "Elvira II Original / Packed 98-glyph",
